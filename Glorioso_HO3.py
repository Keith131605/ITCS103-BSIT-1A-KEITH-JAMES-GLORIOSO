...
button=tk.Button(frame, text="MULTIPLICATION",command = substract,font=("arial", 10,"bold"),bg="yellow")
button.grid(row=7,column=0)
button = tk.Button(frame,text="SUBTRACTION",command = multiply,font=("arial", 10, "bold"),bg="yellow")
